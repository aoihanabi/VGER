            ...
            <div class="custom-number-input col-span-3">
              ...
              <div class="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
                ...
                <input type="number" id="purchase_quantity" min="1" 
                  class="styled_input focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700  outline-none"
                  value="1">
