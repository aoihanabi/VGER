<div id="home-categories" class="py-2 bg-white grid grid-cols-2 gap-2">
    <div class="h-96 row-span-2 bg-cover bg-center bg-no-repeat" style="background-image: url(images/page/hogar-bg.jpg);">
