...
<!-- ************************* MODAL WINDOW ************************ -->
    <Transition name="fade">
        <div v-if="showing" 
            class="fixed inset-0 w-full h-screen z-30 flex items-center justify-center bg-gray-700 bg-opacity-50"
            @click.self="close"
        >
                    ...
                    >
                        <div class="my-2 grid md:grid-cols-8 grid-cols-4 gap-3 ">
                            ...
                            <input type="number" 
                                    ...
                                    class="w-15 p-2 focus:outline-none text-center bg-gray-300 font-semibold text-md hover:text-black focus:text-black md:text-basecursor-default flex items-center text-gray-700 outline-none text-sm md:text-base"
                        >                  
